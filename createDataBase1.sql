...
--ON  PRIMARY 
--( NAME = N'DemoAppDb1', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10.EXPRESS2008\MSSQL\DATA\DemoAppDb1.mdf' , SIZE = 2048KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
-- LOG ON 
--( NAME = N'DemoAppDb1_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10.EXPRESS2008\MSSQL\DATA\DemoAppDb1_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
--GO
...
begin
EXEC [DemoAppDb1].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO

ALTER DATABASE [DemoAppDb1] SET ANSI_NULL_DEFAULT OFF 
GO

ALTER DATABASE [DemoAppDb1] SET ANSI_NULLS OFF 
GO

ALTER DATABASE [DemoAppDb1] SET ANSI_PADDING OFF 
GO

ALTER DATABASE [DemoAppDb1] SET ANSI_WARNINGS OFF 
GO

ALTER DATABASE [DemoAppDb1] SET ARITHABORT OFF 
GO

ALTER DATABASE [DemoAppDb1] SET AUTO_CLOSE OFF 
GO

ALTER DATABASE [DemoAppDb1] SET AUTO_SHRINK OFF 
GO

ALTER DATABASE [DemoAppDb1] SET AUTO_UPDATE_STATISTICS ON 
GO

ALTER DATABASE [DemoAppDb1] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO

ALTER DATABASE [DemoAppDb1] SET CURSOR_DEFAULT  GLOBAL 
GO

ALTER DATABASE [DemoAppDb1] SET CONCAT_NULL_YIELDS_NULL OFF 
GO

ALTER DATABASE [DemoAppDb1] SET NUMERIC_ROUNDABORT OFF 
GO

ALTER DATABASE [DemoAppDb1] SET QUOTED_IDENTIFIER OFF 
GO

ALTER DATABASE [DemoAppDb1] SET RECURSIVE_TRIGGERS OFF 
GO

ALTER DATABASE [DemoAppDb1] SET  DISABLE_BROKER 
GO

ALTER DATABASE [DemoAppDb1] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO

ALTER DATABASE [DemoAppDb1] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO

ALTER DATABASE [DemoAppDb1] SET TRUSTWORTHY OFF 
GO

ALTER DATABASE [DemoAppDb1] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO

ALTER DATABASE [DemoAppDb1] SET PARAMETERIZATION SIMPLE 
GO

ALTER DATABASE [DemoAppDb1] SET READ_COMMITTED_SNAPSHOT OFF 
GO

ALTER DATABASE [DemoAppDb1] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [DemoAppDb1] SET RECOVERY SIMPLE 
GO

ALTER DATABASE [DemoAppDb1] SET  MULTI_USER 
GO

ALTER DATABASE [DemoAppDb1] SET PAGE_VERIFY CHECKSUM  
GO

ALTER DATABASE [DemoAppDb1] SET DB_CHAINING OFF 
GO

ALTER DATABASE [DemoAppDb1] SET  READ_WRITE 
GO
USE [DemoAppDb1]
GO
